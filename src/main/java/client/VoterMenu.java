...
public class VoterMenu {
    ...
    public static void main(String[] args) {
        ...
        IdolVoting.setVoterLinkedList(initVoter());
        //Menu
        //default Value
        int choice;
    ...
    public static LinkedList<Voter> initVoter() {    
        ...
        IdolVoting.getVoterLinkedList().add(voter1);
        IdolVoting.getVoterLinkedList().add(voter2);

        return IdolVoting.getVoterLinkedList();
